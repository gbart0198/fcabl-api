...
---------------------------------------------------
-- 5. GAMES (Scheduled Matchups)
---------------------------------------------------
-- Past games (with results)
INSERT INTO games (home_team_id, away_team_id, game_time, created_at, updated_at) VALUES
(1, 2, '2024-02-10 14:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(3, 4, '2024-02-10 16:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(5, 6, '2024-02-10 18:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(2, 3, '2024-02-17 14:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(4, 5, '2024-02-17 16:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(6, 1, '2024-02-17 18:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(1, 3, '2024-02-24 14:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(2, 4, '2024-02-24 16:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(5, 1, '2024-03-02 14:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(3, 6, '2024-03-02 16:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(4, 1, '2024-03-09 14:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(2, 5, '2024-03-09 16:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
-- Upcoming games (no results yet)
(1, 4, '2024-12-20 18:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(3, 5, '2024-12-20 20:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(2, 6, '2024-12-27 18:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00'),
(1, 5, '2025-01-03 18:00:00', '2024-01-15 10:00:00', '2024-01-15 10:00:00');

---------------------------------------------------
-- 6. GAME_RESULTS (Scores and Outcome)
---------------------------------------------------
-- Results for completed games only
INSERT INTO game_results (game_id, home_score, away_score, winning_team_id, recorded_at) VALUES
(1, 18, 21, 2, '2024-02-10 16:00:00'),    -- Lightning Bolts win
(2, 14, 12, 3, '2024-02-10 18:00:00'),    -- Phoenix Rising win
(3, 10, 15, 6, '2024-02-10 20:00:00'),    -- Wildcats win
(4, 24, 18, 2, '2024-02-17 16:00:00'),    -- Lightning Bolts win
(5, 14, 14, NULL, '2024-02-17 18:00:00'), -- Draw
(6, 16, 19, 1, '2024-02-17 20:00:00'),    -- Thunder Strikers win
(7, 21, 17, 1, '2024-02-24 16:00:00'),    -- Thunder Strikers win
(8, 22, 15, 2, '2024-02-24 18:00:00'),    -- Lightning Bolts win
(9, 12, 20, 1, '2024-03-02 16:00:00'),    -- Thunder Strikers win
(10, 19, 19, NULL, '2024-03-02 18:00:00'),-- Draw
(11, 13, 18, 1, '2024-03-09 16:00:00'),   -- Thunder Strikers win
(12, 25, 18, 2, '2024-03-09 18:00:00');   -- Lightning Bolts win
...
SELECT setval('game_results_id_seq', (SELECT MAX(id) FROM game_results));
